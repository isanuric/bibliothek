...
public class AlgorithmServiceTest extends BibliothekApplicationTests {
    ...
    public void calculateRectangles_Big() {
        int[] xAxis = new int[]{0, 11, 25, 26, 29, 30, 40, 44, 56, 65, 71, 87, 98, 100, 108, 130, 149, 153, 161, 173, 179, 200};
